...
const About = () => {
  return (
    <div className="w-2/3 flex flex-col gap-12 py-5">
      ...
      <CustomDiv>
        <h2 className="text-3xl font-semibold text-white-800">
          <CustomBubbleText text={"About Us"} />
        </h2>
